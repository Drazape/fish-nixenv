...
Because environment variables are the only thing that direnv can modify, that is all we use to get all the information we need to hook current Fish plugin repository for our development environment.
